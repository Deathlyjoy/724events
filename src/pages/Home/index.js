...
const Page = () => {
  ...
  return <>
    ...
    <main>
      ...
      <section className="ServicesContainer" id="nos-services"> {/* Ajout id -> ancrage nav header */}
      ...
      <section className="EventsContainer" id="nos-realisations"> {/* Ajout id -> ancrage nav header */}
        <h2 className="Title">Nos réalisations</h2> 
        <EventList />
      </section>
      <section className="PeoplesContainer" id="notre-equipe"> {/* Ajout id -> ancrage nav header */}
